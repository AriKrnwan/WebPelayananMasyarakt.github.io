...
function FormAdminPBIJK() {
    ...
    const validateForm = () => {
        ...
        if (selectedData.suket_rawat_inap.length === 0) newErrors.suket_rawat_inap = 'Field tidak boleh kosong';
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await api.post('/admin-upload-PBI-JK', formData, config);
    ...
    return (
        <>
            ...
            <InputFile
                ...
                onChange={(e) => handleFileChange('suket_rawat_inap', Array.from(e.target.files))}
