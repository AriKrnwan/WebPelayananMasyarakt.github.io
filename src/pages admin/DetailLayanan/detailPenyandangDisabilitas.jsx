...
function DetailPenyandangDisabilitas() {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await api.put(`update-penyandang-disabilitas/${nopel}`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    const handleValid = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await api.put(`update-penyandang-disabilitas/${nopel}`, {
...
export default DetailPenyandangDisabilitas;
