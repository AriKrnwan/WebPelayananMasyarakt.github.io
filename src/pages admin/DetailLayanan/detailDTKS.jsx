...
function DetailDTKS() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await api.get(`/lay-DTKS/${nopel}`, {
                    headers: {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await api.put(`update-DTKS/${nopel}`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    const handleValid = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await api.put(`update-DTKS/${nopel}`, {
