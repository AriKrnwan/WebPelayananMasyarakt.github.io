...
function DetailSantunanKematian() {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await api.put(`update-santunan-kematian/${nopel}`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    const handleValid = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await api.put(`update-santunan-kematian/${nopel}`, {
...
export default DetailSantunanKematian;
