...
function DetailRehabLansia() {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await api.put(`update-rehabilitasi-lansia/${nopel}`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    const handleValid = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await api.put(`update-rehabilitasi-lansia/${nopel}`, {
...
export default DetailRehabLansia;
