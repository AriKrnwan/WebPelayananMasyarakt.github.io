                ...
                <div className="text-wellcome">
                    <div className="text-top d-flex gap-1 align-items-center">
                        <div className="text-bg text-white px-2 py-1 rounded-2">
                            <p className="ubuntu-sans-medium">Selamat Datang</p>
                        </div>
                        <div className="text-nonbg text-white">
                            <p className="ubuntu-sans-medium">di</p>
                        </div>
                    </div>
                    <div className="text-bottom ubuntu-sans-medium text-white">Platform Pelayanan Publik</div>
                </div>
